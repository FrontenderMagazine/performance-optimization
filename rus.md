...
Снижение производительности может влиять на [вовлечённость][2] пользователей,
на их ощущения от [взаимодействия][3] с сайтом и его [доходность][4].
К счастью, команда проекта «Make The Web Faster» из Google
предложила набор наилучших [практик][5] для поддержания 
...
**Примечание:** Генератор webapp для [Grunt][12] и [Gulp][13] от команды 
...
[Imager.js][Imager.js], элементом `<picture>` или полифилом 
[picturefill][picturefill].
*   [grunt-clowncar][grunt-clowncar]

Кроме того, если вам нужно изменить размер больших изображений,
можете воспользоваться [grunt-image-resize][21].
...
**Примечание:** [Тест][23], проведённый WebPageTest, говорит, что в 
...
анти-паттерном, влекущим за собой [низкую производительность][25] на мобильных 
устройствах.
...
[10][26] до [120 Кб][27] экономии на типовой Bootstrap-странице, и настолько же 
...
[Ильи Григорика][34], для Open Sans уменьшение размера было более чем на 10%, 
...
Одним из инструментов, на которые стоит обратить внимание является [AssetGraph][38].
